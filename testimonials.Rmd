...
#### <b> Kathleen Taylor-John </b>
<h6>Alice kindly hosted a face to face group session for the RWAS Leadership Programme 23/24. I found Alice highly engaging and inspiring. The session was thought provoking in regards to listening skills and how to present ourselves as different types of leaders. I would highly recommend turning to Alice if you are within the agricultural sector, as Alice holds a deep appreciation for the challenges in the sector and is highly approachable for a motivational discussion.</h6>

<br>

#### <b> Sarah Bays </b>
<h6>I came into contact with Alice when she hosted an excellent networking session run by Bloom Mediator Mentoring. Alice very kindly offered to connect with me as a new mediator preparing to "jump off the cliff" and start practising.
Embarking upon a new career is always an exciting yet nerve-wracking experience and I am really very grateful to Alice for her excellent guidance and encouragement to take the plunge, as well as for giving me the benefit of her practical experience in building a client base.
<br>
Alice's experience and advice have given me just the boost I needed to have more confidence in my own skills and competence. I really look forward to building on my experience and hopefully working with Alice in the future.
<br>
Thanks so much Alice for so generously giving me your time and support.</h6>
